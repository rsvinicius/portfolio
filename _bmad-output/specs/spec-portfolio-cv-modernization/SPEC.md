...
- **CAP-5**
  ...
  - **success:** A dedicated showcase displays MockK (v1.14.0 merged PR resolving state leak), dotme CLI, n8n-docs, and microbot with links to external proof repositories.
